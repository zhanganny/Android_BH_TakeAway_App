...
public class SellerFoodItemInformation extends Activity {
    ...
    private void showPhotoPerDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", (dialog, which) -> ActivityCompat.requestPermissions(SellerFoodItemInformation.this, new String[]{Manifest.permission.CAMERA}, PERMISSIONS_REQUEST_PHOTO)).create().show();
    }
    ...
    private void showFilePerDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", (dialog, which) -> ActivityCompat.requestPermissions(SellerFoodItemInformation.this, new String[]{
